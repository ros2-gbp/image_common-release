## image_common (rolling) - 7.0.4-1

The packages in the `image_common` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling image_common` on `Thu, 03 Sep 2026 13:57:22 -0000`
...
## image_common (rolling) - 7.0.3-1

The packages in the `image_common` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling image_common` on `Fri, 17 Jul 2026 14:45:04 -0000`
...
## image_common (lyrical) - 6.4.10-1

The packages in the `image_common` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical image_common` on `Fri, 05 Jun 2026 10:46:41 -0000`
...
- upstream repository: https://github.com/ros-perception/image_common
- release repository: https://github.com/ros2-gbp/image_common-release.git
- rosdistro version: `6.4.9-1`
- old version: `6.4.9-1`
- new version: `6.4.10-1`
...
## image_common (rolling) - 7.0.2-1

The packages in the `image_common` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling image_common` on `Fri, 05 Jun 2026 10:43:40 -0000`
...
## image_common (humble) - 3.1.13-1

The packages in the `image_common` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble image_common` on `Fri, 29 May 2026 08:45:13 -0000`
...
- upstream repository: https://github.com/ros-perception/image_common
- release repository: https://github.com/ros2-gbp/image_common-release.git
- rosdistro version: `3.1.12-1`
- old version: `3.1.12-1`
- new version: `3.1.13-1`
...
## image_common (jazzy) - 5.1.8-1

The packages in the `image_common` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy image_common` on `Fri, 29 May 2026 08:38:48 -0000`
...
## image_common (kilted) - 6.1.4-1

The packages in the `image_common` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted image_common` on `Fri, 29 May 2026 08:28:34 -0000`
...
## image_common (lyrical) - 6.4.9-1

The packages in the `image_common` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical image_common` on `Fri, 29 May 2026 08:23:00 -0000`
...
## image_common (rolling) - 7.0.1-1

The packages in the `image_common` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling image_common` on `Fri, 29 May 2026 08:01:59 -0000`
...
## image_common (rolling) - 7.0.0-1

The packages in the `image_common` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling image_common` on `Wed, 06 May 2026 19:34:56 -0000`
...
## image_common (rolling) - 6.4.6-1

The packages in the `image_common` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling image_common` on `Tue, 24 Mar 2026 21:12:39 -0000`
...
## image_common (rolling) - 6.4.5-1

The packages in the `image_common` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling image_common` on `Wed, 25 Feb 2026 12:53:42 -0000`
...
## image_common (rolling) - 6.4.4-1

The packages in the `image_common` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling image_common` on `Tue, 23 Dec 2025 14:44:56 -0000`
...
## image_common (rolling) - 6.4.3-1

The packages in the `image_common` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling image_common` on `Mon, 24 Nov 2025 14:43:23 -0000`
...
## image_common (kilted) - 6.1.3-1

The packages in the `image_common` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted image_common` on `Thu, 16 Oct 2025 09:54:35 -0000`
